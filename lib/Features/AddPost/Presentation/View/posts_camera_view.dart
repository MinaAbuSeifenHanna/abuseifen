...
class PostsCameraView extends StatefulWidget {
  const PostsCameraView({super.key});

  @override
  State<PostsCameraView> createState() => _PostsCameraViewState();
}

class _PostsCameraViewState extends State<PostsCameraView> {
                                      ...
                                      Bounceable(
                                        ...
                                        onTap: () async {
                                          ...
                                          if (!cameraState.isVideo) {
                                            ...
                                            } else if (!cameraState.isRecording &&
                                                !cameraState.startedRecording) {
                                        ...
                                        TextButton(
                                          ...
                                          child: Text(
                                            ...
                                            style: textTheme.titleSmall!.copyWith(
                                              ...
                                              fontWeight:
                                                  cameraState.isVideo ? FontWeight.bold : FontWeight.normal,
                                            ),
                                          ),
                                        ),
                                        TextButton(
