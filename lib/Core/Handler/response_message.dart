...
class APIResponseMessages {
  ...
  static const String noContent = "Success but No content Found"; // success with no data
  ...
  static const String notFound = "Content not found, Try again later"; // failure, API rejected request
  static const String conflict = "There are some conflicts, Try again later";
  static const String methodNotAllowed = "The method is not allowed for the requested URL.";
